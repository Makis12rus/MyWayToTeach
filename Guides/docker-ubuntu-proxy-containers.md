...
services:
  ...
  s2:
    ...
    ports:
      ...
      # - "30304:30304" # Пример другого P2P TCP порта для ноды
      # - "30304:30304/udp" # Пример другого P2P UDP порта для ноды
  ...
  s3:
    ...
    ports:
      ...
      # - "30305:30305" # Пример другого P2P TCP порта для ноды
      # - "30305:30305/udp" # Пример другого P2P UDP порта для ноды
